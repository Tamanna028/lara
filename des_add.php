...
$res = "INSERT INTO designation (designation_name)VALUES ('".$name."')";
...
<body>
    <h1 class="h2" style=><a class="btn btn-default" href=""> <span class="glyphicon glyphicon-plus"></span> &nbsp; Add Designtion </a> </h1>
...
echo "<td>| <a href=\"des_edit.php?id=$row[id]\">Edit</a> | <a href=\"des_delete.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>"; 
echo "</tr>";
}
}
